...
$$o\_i := D\_{i-1} \cdot \exp(Q\_{i,\*} (KS\_{i,\*})^\top)$$
...
Therefore, sensitivity was defined as sl​=1−σl.​ α represents the sharpness parameter, it controls the extremity of the budget allocation between sensitive and insensitive layers. For Llama, the ideal value was observed to be 1.1, while for qwen it was 1.3.
